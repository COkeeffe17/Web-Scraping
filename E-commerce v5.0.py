...
def get_details(url):
    ...
    data = soup.find('div', class_='row ecomerce-items ecomerce-items-scroll').get('data-items', '')
    info_list = json.loads(html.unescape(data))

    base_url = "https://webscraper.io/test-sites/e-commerce/scroll/product/"
    final_info = []
...
def get_specifics(item):
    ...
    with suppress_stderr():
        ...
        try:
            ...
            urls = [
                f"{base_url}/test-sites/e-commerce/scroll/computers/laptops",
                f"{base_url}/test-sites/e-commerce/scroll/computers/tablets",
                f"{base_url}/test-sites/e-commerce/scroll/phones/touch"
            ]
            ...
            for url in urls:
                ...
                for info in info_list:
                    ...
                    if item[0] == info["title"]:
                        id = info["id"]
                        product_url = "https://webscraper.io/test-sites/e-commerce/scroll/product/" + str(id)
...
def search_for_items():
    ...
    while not done:
        ...
        for name, price, _ in fast_results:
            ...
            product_url = f"https://webscraper.io/test-sites/e-commerce/scroll/product/{id_lookup[name]}"
...
def main_menu():
    ...
    urls = ["https://webscraper.io/test-sites/e-commerce/scroll/computers/laptops?page=1", 
            "https://webscraper.io/test-sites/e-commerce/scroll/computers/tablets?page=1", 
            "https://webscraper.io/test-sites/e-commerce/scroll/phones/touch?page=1"]
